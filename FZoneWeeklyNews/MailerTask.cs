...
namespace FashionZone.FZoneWeeklyNews
{
    public class MailerTask
    {
        ...
        public void Execute()
        {
            ...
            List<CAMPAIGN> campaigns = ApplicationContext.Current.Campaigns.Search(searchCampaign, 100, 0, out TotalCampaignsForToday, "EndDate", BL.Util.SortDirection.Ascending);
            ...
            {
                log("Already sent an email today!");
                return;
            }

            StringBuilder subject = new StringBuilder();
            subject.Append("Markat ne FZone: ");
